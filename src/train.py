...
def train_model(model, X_train, X_valid, y_train, y_valid, validation_steps=None):
    ...
    #gradient descent
#    model.compile(loss='mean_squared_error', optimizer=SGD(lr=1.0e-4))
...
#    model.fit_generator(train_generator, epochs=25, validation_data = validation_generator, verbose = 1)
...
>>>>>>> cece5aacd404336b2a8c3b3fcaf2a3695634af0c
